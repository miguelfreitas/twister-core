...
{ //  name                      actor (function)         okSafeMode threadSafe  allowOnPublicServer
  //  ------------------------  -----------------------  ---------- ----------  -------------------
    ...
    { "usersearch",             &usersearch,             false,     true,       true },
};
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "usersearch"             && n > 2) ConvertTo<boost::int64_t>(params[2]);
    if (strMethod == "usersearch"             && n > 3) ConvertTo<boost::int64_t>(params[3]);
